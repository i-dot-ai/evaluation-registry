...
class AutoGeneratedEvaluation(models.Model):
    url = models.URLField(help_text="link to published pdf  report")
    plain_text = models.TextField(help_text="plain text version of pdf", null=True, blank=True)
    ai_generated_data = models.JSONField(help_text="AI generated data", null=True, blank=True)
    cleaned_data = models.JSONField(help_text="cleaned AI data", null=True, blank=True)
